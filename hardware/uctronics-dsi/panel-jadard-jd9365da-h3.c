...
/* Uctronics AI in a Box 720x1280 panel — init extracted from old kernel
 * jadard_jd9365da_enable() at 0x6df990 via disassembly.
 */
static const struct jadard_init_cmd uctronics_lcd_init_cmds[] = {
	{ .data = { 0xE0, 0x00 } },
	{ .data = { 0xE1, 0x93 } },
	{ .data = { 0xE2, 0x65 } },
	{ .data = { 0xE3, 0xF8 } },
...
static const struct jadard_panel_desc uctronics_lcd_desc = {
	.mode = {
		.clock		= 66000,
		.hdisplay	= 720,
		.hsync_start	= 720 + 40,
	...
	.lanes = 4,
	.format = MIPI_DSI_FMT_RGB888,
	.init_cmds = uctronics_lcd_init_cmds,
	.num_init_cmds = ARRAY_SIZE(uctronics_lcd_init_cmds),
};
