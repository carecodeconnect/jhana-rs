...
/* Uctronics AI in a Box 720x1280 panel — init sequence extracted from
 * Radxa Ubuntu 22.04 kernel binary (vmlinuz-5.10.110-102).
 * See hardware/uctronics-dsi/ili9881c-init-sequence.c for extraction method.
 */
static const struct ili9881c_instr uctronics_lcd_init[] = {
	// Page 0 — unlock and basic config
	ILI9881C_SWITCH_PAGE_INSTR(0),
...
static const struct drm_display_mode uctronics_lcd_default_mode = {
	.clock		= 66000,
	.hdisplay	= 720,
	.hsync_start	= 720 + 40,
	.hsync_end	= 720 + 40 + 20,
...
static const struct ili9881c_desc uctronics_lcd_desc = {
	.init = uctronics_lcd_init,
	.init_length = ARRAY_SIZE(uctronics_lcd_init),
	.mode = &uctronics_lcd_default_mode,
