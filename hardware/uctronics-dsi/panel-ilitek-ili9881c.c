...
/* Uctronics AI in a Box 720x1280 panel — correct init sequence extracted
 * from baseline image kernel (5.10.110-102-rockchip) by disassembling
 * jadard_jd9365da_enable @ 0x6df990. Panel IC is ILI9881C despite the
 * driver function name. See ili9881c-init-extracted.c for full details.
 */
static const struct ili9881c_instr uctronics_lcd_init[] = {
	/* Page 3: GIP timing (128 registers) */
	ILI9881C_SWITCH_PAGE_INSTR(3),
	ILI9881C_COMMAND_INSTR(0x01, 0x00),
	ILI9881C_COMMAND_INSTR(0x02, 0x00),
	ILI9881C_COMMAND_INSTR(0x03, 0x73),
	...
	ILI9881C_COMMAND_INSTR(0x89, 0x02),
	ILI9881C_COMMAND_INSTR(0x8A, 0x02),
	/* Page 4: Power/MIPI config (13 registers) */
	ILI9881C_SWITCH_PAGE_INSTR(4),
	ILI9881C_COMMAND_INSTR(0x00, 0x80),
	ILI9881C_COMMAND_INSTR(0x70, 0x00),
	ILI9881C_COMMAND_INSTR(0x71, 0x00),
	...
	ILI9881C_COMMAND_INSTR(0x3A, 0x24),
	ILI9881C_COMMAND_INSTR(0x88, 0x33),
	/* Page 1: VCOM/power config (7 registers) */
	ILI9881C_SWITCH_PAGE_INSTR(1),
